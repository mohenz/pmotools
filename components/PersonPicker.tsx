...
export function PersonPicker({ people, selectedIds, selectedNames, onChange, allowGuests = true }: { people: Person[]; selectedIds: string[]; selectedNames: string[]; onChange: (selectedIds: string[], selectedNames: string[]) => void; allowGuests?: boolean }) {
  ...
  return <>
    ...
    {allowGuests && <div className="attendee-guest-add">
