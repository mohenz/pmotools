...
- 모듈명을 단순 나열하지 말고 내용 기준으로 통합·재구성하되, 어느 업무모듈에서 있었던 내용인지는 불릿 안에 구체적으로 밝히세요.
...
- 각 섹션 3~6개 불릿, 불릿마다 1~2문장으로 충분히 구체적으로 작성하세요. 전체 글자 수는 제한하지 말고, 원문에 담긴 내용의 밀도에 맞춰 빠짐없이 반영하세요.
