...
export async function GET(req: NextRequest) { const c = await getLocalContext(); return NextResponse.json({ data: await listMeetingRooms(c.projectId, isManagerRole(c.role) && req.nextUrl.searchParams.get("archived") === "1") }); }
