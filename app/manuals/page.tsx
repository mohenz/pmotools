...
export default async function ManualsPage() {
  ...
  return <><header className="topbar"><div><h1>메뉴얼</h1><p>PMOTOOLS 주요 기능의 관리자·사용자 안내서입니다.</p></div></header><div className="content manual-content"><section className="panel manual-list-panel">
    <div className="panel-head"><h2>기능별 메뉴얼</h2><span>{MANUALS.length}개</span></div>
