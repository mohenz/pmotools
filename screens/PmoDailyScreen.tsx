...
export function PmoDailyScreen({ data, mode }: { data: PmoDailyDashboard; mode: "new" | "edit" }) {
  ...
  return <>
    ...
    <div className="content pmo-daily-content">
      ...
      <section className="panel" id="delayed"><div className="panel-head"><h2>2. 지연 TASK</h2><div className="topbar-actions"><span>WBS 기준 {data.delayedTaskTotal}건</span><Link className="button secondary" href="/wbs/group-tasks?delayed=1">전체 보기</Link></div></div>
